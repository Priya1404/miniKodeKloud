...
interface SortFilterModalProps {
  ...
  selected: string[];
  onApply: (sortIds: string[]) => void;
  onClose: () => void;
}

const SortFilterModal: React.FC<SortFilterModalProps> = ({ visible, sortOptions, selected, onApply, onClose }) => {
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            ...
            return (
              <TouchableOpacity style={styles.itemContainer} onPress={() => toggleSort(item.id)}>
